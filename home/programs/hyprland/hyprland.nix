...
#      };
      ...
      curve = {_args = ["myBezier" { type = "bezier"; points = [ [ 0.05  0.9 ]  [ 0.1  1.05 ] ];}];};

        #animation = [
      animation = [
        #  "windows, 1, 4, myBezier"
        { leaf = "windows"; enabled = true; speed = 4; bezier = "myBezier"; }
        ...
        { leaf = "borderangle"; enabled = true; speed = 3; bezier = "default"; }
        #  "fade, 1, 3, default"
